...
import com.luna.securityloginlogout.auth.RestApiLoginAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        RestApiLoginAuthFilter restApiLoginAuthFilter =
                new RestApiLoginAuthFilter(
                        PathPatternRequestMatcher.pathPattern(HttpMethod.POST,"/api/v1/auth/login" ), authenticationManager);
