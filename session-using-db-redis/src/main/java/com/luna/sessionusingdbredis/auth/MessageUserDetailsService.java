...
import com.luna.sessionusingdbredis.entity.MessageUserEntity;
import com.luna.sessionusingdbredis.repository.MessageUserRepository;
...
public class MessageUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        MessageUserEntity messageUserEntity = messageUserRepository
